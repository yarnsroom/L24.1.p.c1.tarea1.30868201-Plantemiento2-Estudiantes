...
salida.innerHTML += `El estudiante con cedula: ${
  estUno.cedula
} obtuvo una nota total de: ${estUno.notaTotal()} puntos <br>`;
salida.innerHTML += `El estudiante con cedula: ${
  estDos.cedula
} obtuvo una nota total de: ${estDos.notaTotal()} puntos <br>`;
salida.innerHTML += `El estudiante con cedula: ${
  estTres.cedula
} obtuvo una nota total de: ${estTres.notaTotal()} puntos <br>`;
salida.innerHTML += `El estudiante con cedula: ${
  estCuatro.cedula
} obtuvo una nota total de: ${estCuatro.notaTotal()} puntos <br>`;
